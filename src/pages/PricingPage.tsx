...
export function PricingPage() {
  ...
  return (
    <>
      <SEO
        title="Ціни на послуги салону краси в Чернігові — Майстерня Краси (ЦУМ)"
        description="Актуальні ціни на стрижки, фарбування, блонд, balayage, airtouch, манікюр та педикюр у салоні краси Майстерня Краси в Чернігові (ЦУМ, 2 поверх). Запис онлайн."
      />
      <LocalBusinessSchema />
