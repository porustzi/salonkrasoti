            ...
            <div className="space-y-6 text-neutral-700">
              <section>
                ...
                <p>
                  ...
                  управляється салоном {BUSINESS_INFO.name}.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Усі матеріали сайту (тексти, зображення, дизайн) є власністю {BUSINESS_INFO.name}
              ...
              <section>
                ...
                <p>
                  ...
                  {BUSINESS_INFO.address}, {BUSINESS_INFO.city}<br />
