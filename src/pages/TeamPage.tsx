...
export function TeamPage() {
  ...
  return (
    <>
      <SEO
        title="Наша команда майстрів — салон краси Майстерня Краси, Чернігів"
        description="14 професійних майстрів салону краси Майстерня Краси в Чернігові (ЦУМ): перукарі, колористи, майстри манікюру з досвідом понад 10 років."
      />
      <LocalBusinessSchema />
