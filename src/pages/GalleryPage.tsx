...
export function GalleryPage() {
  ...
  return (
    <>
      <SEO
        title="Галерея робіт — салон краси Майстерня Краси, Чернігів"
        description="Портфоліо робіт салону краси Майстерня Краси в Чернігові (ЦУМ): фарбування, блонд, стрижки, укладки, манікюр. Приклади наших робіт."
      />
