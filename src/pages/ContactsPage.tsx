...
export function ContactsPage() {
  ...
  return (
    <>
      <SEO
        title="Контакти салону краси Майстерня Краси — Чернігів, ЦУМ"
        description="Салон краси Майстерня Краси в Чернігові: просп. Миру 49, ЦУМ «Чернігів», 2 поверх. Телефон +38 (063) 844-77-25. Години роботи 10:00–21:00 щодня. Карта проїзду."
      />
      <LocalBusinessSchema />
